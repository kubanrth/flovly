  ...
  return (
    <header data-ui="topbar" className="sticky top-0 z-[var(--z-sticky)] flex h-12 shrink-0 items-center gap-1.5 border-b border-border bg-card px-2 md:gap-2 md:px-3">
      ...
      <button
        ...
        className="hidden h-8 w-[480px] items-center gap-2 rounded-md border border-border bg-n-50 px-2.5 text-left text-sm text-fg-3 outline-none hover:border-input-border-hover hover:bg-n-100 active:bg-n-100 md:flex"
      >
