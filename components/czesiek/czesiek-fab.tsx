  ...
  return (
    <>
      ...
      >
        ...
        <span
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 -z-10 rounded-full bg-brand-gradient opacity-70 animate-[ping_2.4s_cubic-bezier(0,0,0.2,1)_infinite]"
        />
        {/* Soft halo — pulsująca poświata w miejscu */}
        <span
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 -z-10 animate-pulse rounded-full bg-brand-gradient opacity-50 blur-lg"
        />
      </button>
